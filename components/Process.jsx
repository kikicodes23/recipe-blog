...
export function Process() {
    ...
    const ingredients = [
        { title: "1 and 1/2 cups (150g) <span>graham cracker crumbs</span> (about 10 full sheet graham crackers)", section: "Crust" },
        { title: "5 Tablespoons (70g) <span>unsalted butter</span>, melted", section: "Crust" },
        { title: "1/4 cup (50g) <span>granulated sugar</span>", section: "Crust" },
        { title: "four 8-ounce blocks (904g) full-fat <span>cream cheese</span>, softened to room temperature", section: "cheesecake" },
        { title: "1 cup (200g) <span>granulated sugar</span>", section: "cheesecake" },
        { title: "1 cup (240g) full-fat <span>sour cream</span>, at room temperature", section: "cheesecake" },
        { title: "1 teaspoon <span>pure vanilla extract</span>", section: "cheesecake" },
        { title: "2 teaspoons <span>fresh lemon juice</span> (optional, but recommended)", section: "cheesecake" },
        { title: "3 large <span>eggs</span>, at room temperature", section: "cheesecake" },
        ...
        <article className="xl:px-[237px] xl:flex xl:justify-between xl:flex-row-reverse xl:pt-9">
            <section className="flex flex-col pl-3 pr-[43px] pt-3 gap-[21px] xl:w-[216px] xl:h-[367px] xl:bg-white xl:rounded-xl xl:drop-shadow-xl xl:pl-10 xl:pr-0 xl:justify-center xl:gap-[43px]">
                <div className="flex items-center gap-[4px] xl:gap-[11px]">
                    ...
                    <div>
                        <p className="text-[8px] font-bold text-[#BDBDBD] uppercase sm:text-[10px]">yields</p>
                        <p className="text-[10px] font-medium text-[#F2994A] sm:text-sm">12 servings</p>
                    </div>
                </div>
